...
static void test_get_key_value_success(void **data)
{
...
static void test_get_key_value_failure(void **data)
{
    struct test_input values[] = {
        {
            .input = "value,",
...
static void test_process_hints(void **data)
{
    const char *expected_keys[] = {
        "key", "key2"
    };
...
int main(void)
{
    const struct CMUnitTest test_hints[] = {
        cmocka_unit_test(test_get_key_value_success),
        cmocka_unit_test(test_get_key_value_failure),
        cmocka_unit_test(test_process_hints),
    };
